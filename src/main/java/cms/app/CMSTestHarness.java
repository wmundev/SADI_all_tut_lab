...
public class CMSTestHarness {
    // this implies an interface or abstract class but since not covered
    // until next week you can
    // change to
    // CourierManagementSystem cms = new CourierManagementSystem() if you prefer
    // (it will get updated in the next tutelab week anyway!)
    final protected static CourierManagementSystem cms = new
            CourierManagementSystemImpl();
     ...
     */
    protected static boolean testSchedule(String reg, double distance,
                                          boolean schedule) {
    ...
    public static void main(String[] args) {
        ...
        cms.addVehicle(new SimpleVan("v1", "Toyota", "Sienna", 1998, 0.0,
                500.0));
        cms.addVehicle(new SimpleVan("v2", "Volkswagen", "Routan S", 2009,
                0.0, 1000.0));

        // SimpleTruck(reg, make, model, year, odo, serviceInterval, capacity)
        cms.addVehicle(new SimpleTruck("t1", "Peterbilt", "379 ", 1990, 0.0,
                2000.0, 3000));
        cms.addVehicle(new SimpleTruck("t2", "Peterbilt", "386", 2005, 0.0,
                2000.0, 3500));

        // Display Vehicle Information
        System.out.format("*Printing Information for Van : %s\n", "v2");
        cms.displayVehicleInfo("v2");
        System.out.format("\n*Printing Information for SimpleTruck : %s\n",
                "t2");
        ...
        System.out.format("\n*Vehicle Information for %s (After Jobs " +
                "Scheduled)...\n", "v2");
        cms.displayVehicleInfo("v2");
